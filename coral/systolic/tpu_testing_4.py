...
def run_edge_tpu_inference():
    model_path = "/home/mendel/119-CycleAccurateHardware/coral/systolic/matmul_4_model_edgetpu.tflite"
    input_data = np.random.randint(0, 10, size=(1, 4)).astype(np.float32)  # shape: (1, 3)
